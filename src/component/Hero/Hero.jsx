        ...
        <div className="hero  bg-base-200">
            <div className="hero-content flex-col lg:flex-row-reverse">
                ...
                <div>
                    ...
                    <button className=" mx-2 px-8 py-2 font-bold border rounded-3xl text-white bg-red-400 hover:bg-white hover:border-red-400 hover:text-red-400 shadow-lg shadow-red-500/50">Get Started</button>
                </div>
            </div>
        </div>
    );
